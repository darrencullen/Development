...
@property (strong, nonatomic) IBOutlet UITableView *tableViewParkingInfo;
...
- (void)viewDidLoad
{
    @try{
        ...
        if (floor(NSFoundationVersionNumber) <= NSFoundationVersionNumber_iOS_6_1) {
            self.tableViewParkingInfo.backgroundView = nil;
            ...
            [self.tableViewParkingInfo setBackgroundView:backView];
        }
