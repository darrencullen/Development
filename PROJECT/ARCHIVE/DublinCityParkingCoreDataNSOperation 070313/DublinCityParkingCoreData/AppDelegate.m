...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"DublinCityParkingCoreData" withExtension:@"momd"];
...
//    }
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"DublinCityParkingCoreDataImport.sqlite"];
//    NSError *error = nil;
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:[storeURL path]]) {
        NSURL *preloadURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"DublinCityParkingCoreDataNSOperation" ofType:@"sqlite"]];
        NSError* err = nil;
